...
public class WatermarkLateDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final OutputTag<WaterSensor> lateTag = new OutputTag<>("late-data");
        final SingleOutputStreamOperator<String> process = env.socketTextStream("192.168.3.24", 9999)
        ...
        process.print();
        process.getSideOutput(lateTag).printToErr("late-data");
        env.execute();
    }
}
